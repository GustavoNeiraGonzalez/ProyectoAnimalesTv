...
const vetYCom = [
    {
        ...
        1:[{
            ...
            texto:['*Nuestros horarios de atención','%este texto esta subrayado','lunes a sábado de 10:00-15:00 y 16:00-18:00','(Colación de 15:00-16:00)'],
...
app.get('/posts/:i/:handle',(req, res) =>{ // Dos puntos en la URL creará una variable (ejemplo --> :NOMBRE_VARIABLE_1/:NOMBRE_VARIABLE_2 )
    ...
    res.render(`vetYCom`, { // Para usar la variable escribir req.params.NOMBRE_VARIABLE
        linkIcono: vetYCom[req.params.i].linkIcono,
        whatsapp: vetYCom[req.params.i].whatsapp,
        texo: vetYCom[req.params.i].texo,
